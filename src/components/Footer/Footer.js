                                ...
                                <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 pr-0">
                                    <div className="footer__widget mb-45 wow fadeInUp" data-wow-delay=".2s">
                                        <div className="footer__widget-title mb-30">
                                            <div className="logo">
                                                <a href="#">
                                                    <img src="assets/img/logo/onetouch.png" alt="" />
                                                </a>
                                            </div>
                                        </div>
                                                ...
                                                <ul>
                                                    <li>
                                                        ...
                                                        <div className="text theme-color ">
                                                            <span><a href="mailto:support@zibber.com">support@onetouchfinace.com.au</a></span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div className="icon theme-color">
                                                        ...
                                                        <div className="text theme-color">
                                                            <span><a href="tel:(+642)-394-396-432">(+61) 394 396 432</a></span>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                ...
                                <div className="row align-items-center">
                                    <div className="col-xl-12">
                                        <div className="footer__copyright-text text-center">
                                            <p>Copyright © 2022 All Rights Reserved passion by <Link to="/home">OneTouch</Link></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
