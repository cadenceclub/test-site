                                            ...
                                            <div className="sidebar__info">
                                                ...
                                                <ul>
                                                    <li>
                                                        ...
                                                        <div className="text">
                                                            <span>3109, Doncaster East, Melbourne</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div className="icon">
                                                        ...
                                                        <div className="text ">
                                                            <span><a href="mailto:support@onetouchfinance.com.au">support@onetouchfinance.com.au</a></span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div className="icon">
                                                        ...
                                                        <div className="text">
                                                            <span><a href="tel:(+61)-394-396-432">(+642) 394 396 432</a></span>
                                                        </div>
                                                    </li>
                                                </ul>
                                                </div>
